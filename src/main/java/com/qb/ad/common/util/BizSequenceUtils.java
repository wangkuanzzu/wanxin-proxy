...
public class BizSequenceUtils {
    ...
    public String generateBizSeqNo(String bizSeqNoPrefix) {
        ...
        bizSeqNo.append(bizSeqNoPrefix)
                .append(DateUtils.getCurrentDateStr("yyyyMMdd"))
                .append(getSeq());
    ...
    public static void main(String []ar){
        BizSequenceUtils.getInstance().getSeq();

        System.out.println(BizSequenceUtils.getInstance().getSeq());
        System.out.println(BizSequenceUtils.getInstance().generateBizSeqNo("0395"));
    }
}
